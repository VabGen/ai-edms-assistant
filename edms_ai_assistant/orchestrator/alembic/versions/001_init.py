...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("file_identifier", "summary_type", name="_file_summary_type_uc"),
        schema="edms",
    )
    op.create_index("ix_sumcache_file", "summarization_cache", ["file_identifier"], schema="edms")
    op.create_index("ix_sumcache_type", "summarization_cache", ["summary_type"], schema="edms")
    ...
    op.create_table(
        ...
        sa.Column("user_id", sa.String(255), sa.ForeignKey("edms.user_profiles.user_id", ondelete="CASCADE"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("action_metadata", postgresql.JSONB(astext_type=sa.Text()), nullable=False, server_default="{}"),
    ...
    op.create_table(
        ...
        sa.Column("tool_args", postgresql.JSONB(astext_type=sa.Text()), nullable=False, server_default="{}"),
...
def downgrade() -> None:
    for table in ["dialog_logs", "action_history", "conversation_logs", "user_profiles", "summarization_cache"]:
