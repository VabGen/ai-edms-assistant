...
from edms_ai_assistant.orchestrator.clients import EdmsHttpClient
from edms_ai_assistant.orchestrator.clients import DocumentClient
from edms_ai_assistant.orchestrator.clients import EmployeeClient
from edms_ai_assistant.orchestrator.models.task_models import TaskType
...
def register_workflow_tools(mcp: FastMCP) -> None:
    ...
    async def employee_search_tool(
        ...
        if department_names:
            from edms_ai_assistant.orchestrator.clients import DepartmentClient
